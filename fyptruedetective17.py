# -*- coding: utf-8 -*-
"""FypTrueDetective17.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BZSAX306TmUCu_jylv-DYoueGm7Wf97c
"""
...
epochs = 18 # for better result increase the epochs. epochs = # of iterations over the entire dataset.
batch_size = 50
...
Test_Feats = np.concatenate([Test_Feat1, Test_Feat2], 3)
...
loss, acc = cnsn_model.evaluate(x_train, y_train, verbose=1)
print("  Training : loss %.3f - acc %.3f" % (loss, acc))
